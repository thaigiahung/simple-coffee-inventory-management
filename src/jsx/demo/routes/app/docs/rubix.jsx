...
var treesnippet = require('raw!./snippets/treesnippet.txt');
      ...
      <Container id='body'>
        <DocContainer>
          <DocUnit name='Rubix Documentation'>
            ...
            <p>
              {"Once you have everything setup (if you haven't go back to the "}<Link href='/app/docs/installation'>Installation</Link>{" page and finish the installation) you'll notice a file structure similar to this:"}
            </p>
            <div>
              <pre>
          ...
          <DocUnit name='Rubix Documentation: main.jsx'>
            ...
            <p>
              {"Store all your routes in "}<code>src/jsx/app/routes</code>{" folder and require them in main.jsx. An example route pointing to a blank page is show in the main.jsx file:"}
            </p>
            <div>
              <pre>
                <code className='language-javascript'>
            ...
            <Alert info>
              {"For routing we make use of the excellent "}<AlertLink href='http://andreypopp.github.io/rrouter/' target='_blank'>RRouter</AlertLink>{" library. Its advised that you go through the documentation for RRouter before reading this section"}
            </Alert>
            <p>
