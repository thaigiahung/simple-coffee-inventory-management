...
var sasstreesnippet = require('raw!./snippets/sasstreesnippet.txt');
      ...
      <Container id='body'>
        <DocContainer>
          <DocUnit name='Rubix Documentation'>
            ...
            <p>
              {"Once you have everything setup (if you haven't go back to the "}<Link href='/app/docs/installation'>Installation</Link>{" page and finish the installation) you'll notice a file structure similar to this in your "}<code>src</code> folder:
            </p>
            <div>
              <pre>
