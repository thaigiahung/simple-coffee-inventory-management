                  ...
                  <Row>
                    <Col xs={12} className='fg-white'>
                      <div style={{maxWidth: 600, margin: 'auto'}}>
                        <h3 style={{margin: 25, fontWeight: 100, color: 'rgba(255,255,255,0.35)'}}>⸺</h3>
                    ...
                    <Row>
                      <Col xs={6} collapseLeft collapseRight>
                        <div className='fg-darkgray50'>
                          <small>by <Link href='#'>{this.props.author}</Link> / {this.props.date}</small>
                        </div>
                      </Col>
          ...
          <Row>
            <Col xs={12}>
              <Post 
                ...
                <p>
                  <LoremIpsum query='2s' />{' '}
                  <Link href='#' className='text-capitalize'><LoremIpsum query='2w' /></Link>{' '}
                  <LoremIpsum query='3s' />
                </p>
                <div>
