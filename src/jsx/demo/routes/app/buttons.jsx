                      ...
                      <Row>
                        <Col xs={12} className='text-center'>
                          ...
                          <ButtonGroup justified>
                            <Button bsStyle='brown50' componentClass={React.DOM.a}>Left</Button>
                            <Button bsStyle='darkblue' componentClass={React.DOM.a}>Middle</Button>
                            <Button bsStyle='darkgreen45' componentClass={React.DOM.a}>Right</Button>
                          </ButtonGroup>
                          </div>
                          <br/>
                          <div>
                          <ButtonGroup justified>
                            <Button bsStyle='darkcyan' componentClass={React.DOM.a}>Left</Button>
                            <Button bsStyle='darkbrown' componentClass={React.DOM.a}>Middle</Button>
                            <ButtonGroup>
                          ...
                          <div>
                          <ButtonGroup justified>
                            <Button outlined bsStyle='darkgreen45' componentClass={React.DOM.a}>Left</Button>
                            <Button outlined bsStyle='darkgreen45' componentClass={React.DOM.a}>Middle</Button>
                            <Button outlined bsStyle='darkgreen45' componentClass={React.DOM.a}>Right</Button>
                          </ButtonGroup>
                          </div>
                          <br/>
                          <div>
                          <ButtonGroup justified>
                            <Button outlined bsStyle='brightyellow' componentClass={React.DOM.a}>Left</Button>
                            <Button outlined bsStyle='brightyellow' componentClass={React.DOM.a}>Middle</Button>
                            <ButtonGroup>
