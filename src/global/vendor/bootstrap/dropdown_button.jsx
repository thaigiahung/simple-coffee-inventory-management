  ...
  render: function() {
    ...
    if(this.props.tab || this.props.nav) {
      return this.transferPropsTo(
        <a href='#' ref='button' className={classes} data-toggle='dropdown' onClick={this.handleClick} onTouchEnd={this.handleClick} onMouseOver={this.props.toggleOnHover ? this.handleMouseOver : null}>
          {this.props.children}
        </a>
      );
    }
