...
var Menu = React.createClass({
  ...
  render: function() {
    ...
    return this.transferPropsTo(
      <ul ref='ul' className={classes.length ? classes : null} role='menu' aria-labelledby={this.props.ref} style={this.state.ul} onKeyDown={this.handleKeyDown} onKeyUp={this.handleKeyUp}>
